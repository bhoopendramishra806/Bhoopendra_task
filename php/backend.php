...
// die();
	...
	{   
	    ...
	    $value=array(array('string','mock_test_tbl.mock_test_tbl','CONCAT(Name,Email)','null as name,id,null as Email,null as Phone,null as gender','id'));
	    $query_data=array();
	    ...
	    //echo json_encode($get_query_and_data['query']);
        //die;
	    $where_data=$obj->searching_data($get_ids);

	    $table_from=array("table_name_id","table_name_email");
	    $table1_to=array("mock_test_tbl.mock_test_tbl","mock_test_tbl.mock_test_tbl");
