...
//alert(ajax_url);
            $.ajax({ 
                        type:"POST",
                        async: "true",
                        url:"http://localhost/Pagination-Bhoopendra/"+ajax_url,
                        data:ajax_data,
                        dataType: 'json',
                        beforeSend()
                        {
        ...
        {   
            ...
            { 
                $("head").append('<script type="text/javascript" src="http://localhost/Pagination-Bhoopendra/pagination1.0/simplePagination.js-master/jquery.simplePagination.js"></script>');
                $("head").append('<link rel="stylesheet" href="http://localhost/Pagination-Bhoopendra/pagination1.0/simplePagination.js-master/simplePagination.css">');
